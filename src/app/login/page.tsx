  ...
  return (
    <main className="min-h-screen grid place-items-center bg-neutral-50 px-4">
      <form action={formAction} className="w-full max-w-sm space-y-4 bg-white p-6 rounded-lg shadow">
        <h1 className="text-2xl font-bold font-display">SkateDreams</h1>
        ...
        <button className="w-full bg-brand-dark text-brand-light py-2 rounded font-medium">Entrar</button>
      </form>
    </main>
  );
}
